...
void main() {
  group('design tokens', () {
    ...
    test('score colour blends toward neutral for a weak score, full strength '
        'at the extremes', () {
    ...
    test('positive and negative scores of equal magnitude have distinct '
        'colours', () {
    ...
    testWidgets('committed ADX shows the exact SHORT MOVE exit boundary', (
      ...
      expect(find.text('15M ADX 20.0 · CALM'), findsOneWidget);
      expect(find.text('15M ADX 20.1 · EXIT MOVE'), findsOneWidget);
      expect(find.text('15M ADX 35.0 · TREND'), findsOneWidget);
    });
  });
  ...
  group('native screen coverage', () {
    ...
    test('phone primary navigation is intentionally compact', () {
      expect(primaryPageIndexes, [0, 1, 2, 8, 4, 7]);
